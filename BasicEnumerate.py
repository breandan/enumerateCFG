...
if __name__ == "__main__":
    ...
    #
    # cfg = {
    # "S": [("S", "S"), ("F.[", "S.]"), ("F.{", "S.}"), ("F.(", "S.)"), ("F.(", "F.)"), ("F.[", "F.]"), ("F.{", "F.}"), ("<S>"), ("S", "ε+"), ("ε+", "S")],
    # "START": [("S", "S"), ("F.[", "S.]"), ("F.{", "S.}"), ("F.(", "S.)"), ("F.[", "F.]"), ("F.{", "F.}"), ("F.(", "F.)"), ("START", "F.ε")],
    # "F.(": [("(")],
    # "F.[": [("[")],
    # "F.{": [("{")],
    # "F.]": [("]")],
    ...
    #
    # cfg = {
    # "S": [("S", "S"), ("F.(", "S.)"), ("F.(", "F.)"), ("<S>"), ("S", "ε+"), ("ε+", "S")],
    # "START": [("S", "S"), ("START", "F.ε"), ("F.(", "S.)"), ("F.(", "F.)")],
    # "F.(": [("(")],
    # "F.ε": [("ε")],
    # "F.)": [(")")],
    # "S.)": [("S", "F.)")],
